...
public class ResourceManager {
	...
	private ResourceManager() {
		...
		for (int i = 0; i < 13; i++) {
			cardBlack[i] = new ImageIcon(clazz.getResource("img/card/b" + i
					+ ".gif"));
			cardBlackOpen[i] = new ImageIcon(clazz.getResource("img/card/b" + i
					+ "r.gif"));
			cardWhite[i] = new ImageIcon(clazz.getResource("img/card/w" + i
					+ ".gif"));
			cardWhiteOpen[i] = new ImageIcon(clazz.getResource("img/card/w" + i
					+ "r.gif"));
		}
		...
		cardBlackUnknownRollerover = new ImageIcon(
				clazz.getResource("img/card/bur.gif"));
		cardWhiteUnknownRollerover = new ImageIcon(
				clazz.getResource("img/card/wur.gif"));
	}
